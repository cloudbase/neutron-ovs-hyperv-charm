...
function New-OVSInternalInterfaces {
    ...
    Write-JujuWarning "OVS adapter name is $ovsBridgeName"
    $ovsAdapter = Get-Netadapter $ovsBridgeName
    Enable-NetAdapter -InputObject $ovsAdapter | Out-Null
    Set-OVSAdapterAddress -AdapterInfo $adapterInfo -OVSAdapter $ovsAdapter
}
